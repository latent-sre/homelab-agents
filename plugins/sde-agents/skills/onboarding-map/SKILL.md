...
| Situation | Route | Why |
|---|---|---|
| A machine new to the lab, or rebuilt | `host-onboard` | Host baseline plus role-dependent protection before workloads depend on it; backups apply to irreplaceable state, and access changes require recovery proof |
